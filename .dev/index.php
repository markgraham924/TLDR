...
<html lang="en">
    ...
    <body>
        ...
        <?php
                ...
                if ($success == 'yes'){
                    echo "<div class='alert alert-success' role='alert'>Yay, you've signed up!</div>";
                }
        ...
        <div class="imgntext">
            ...
            <div class="centered">
                <h1 style="text-align: center;">All the music information you ever needed!</h1>
                <p style="text-align: center;">Get an email weekly from us with news on your favourite artists, gigs and suggested content.</p>
                <p style="text-align: center;">We'll look at your popular music choices and recommend you new songs based upon that!</p>
